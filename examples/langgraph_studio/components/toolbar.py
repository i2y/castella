"""Toolbar component for LangGraph Studio."""
...
class Toolbar(Component):
    """Toolbar with graph execution controls.
    ...
    def view(self):
        ...
        return Row(
            ...
            Spacer().fixed_width(BUTTON_SPACING),
            Text(f"{self._zoom_percent}%").fixed_width(48),
            Spacer().fixed_width(BUTTON_SPACING),
    ...
    def _vertical_divider(self):
        ...
        # Simple spacer acts as visual separator
    ...
    def _build_run_button(self):
        ...
        return btn.fixed_width(BUTTON_WIDTH)
    ...
    def _build_continue_button(self):
        ...
        return btn.fixed_width(BUTTON_WIDTH + 8)  # Slightly wider for longer text
    ...
    def _build_zoom_out_button(self):
        ...
        btn = Button("-").fixed_width(SMALL_BUTTON_WIDTH)
    ...
    def _build_fit_button(self):
        ...
        btn = Button("Fit").fixed_width(SMALL_BUTTON_WIDTH + 8)
        if self._on_fit:
