...
class TokyoNightThemeDemo(Component):
    ...
    def view(self):
        ...
        return Column(
            # Header
            Text("Tokyo Night Theme Demo").height(40).height_policy(SizePolicy.FIXED),
            ...
            Row(
                ...
                Column(
                    Text(f"Font: {theme.typography.font_family[:25]}...").height(24).height_policy(SizePolicy.FIXED),
            ...
            # Divider
            Text("--- Text Styles (Tokyo Night colors) ---").height(35).height_policy(SizePolicy.FIXED),

            # Text with different kinds
            Row(
                Text("Primary").width(100).width_policy(SizePolicy.FIXED),
                Text("Cyan", kind=Kind.INFO).width(100).width_policy(SizePolicy.FIXED),
                Text("Green", kind=Kind.SUCCESS).width(100).width_policy(SizePolicy.FIXED),
                Text("Yellow", kind=Kind.WARNING).width(100).width_policy(SizePolicy.FIXED),
                Text("Red", kind=Kind.DANGER).width(100).width_policy(SizePolicy.FIXED),
            ...
            Row(
                Column(
                    ...
                    Text(f"Secondary: {theme.colors.bg_secondary}").height(20).height_policy(SizePolicy.FIXED),
            ...
            Text("Tokyo Night - Storm variant with 6px rounded corners").height(24).height_policy(SizePolicy.FIXED),
        )
